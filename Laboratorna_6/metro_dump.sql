...
CREATE TABLE `metro_lines` (
  ...
  PRIMARY KEY (`id`),
  KEY `city_id` (`city_id`),
  CONSTRAINT `metro_lines_ibfk_1` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `metro_stations` (
  ...
  PRIMARY KEY (`id`),
  KEY `line_id` (`line_id`),
  CONSTRAINT `metro_stations_ibfk_1` FOREIGN KEY (`line_id`) REFERENCES `metro_lines` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'metro'
--
...
-- Dump completed on 2023-05-29 22:16:41
